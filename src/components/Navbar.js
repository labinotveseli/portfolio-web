      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap lg:mt-2">
          <motion.a
            target={"_blank"}
            className="w-6 mx-3"
            href="https://www.linkedin.com/in/labinotveseli"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            target={"_blank"}
            className="w-6 mx-3"
            href="https://github.com/labinotveseli"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            target={"_blank"}
            className="w-6 mx-3 dark:bg-light rounded-edge"
            href="https://twitter.com/labinotveseli"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            target={"_blank"}
            className="w-6 mx-3"
            href="https://www.instagram.com/labinotveseli_"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
      ...
      "
        ...
        >
          ...
          <nav className="flex items-center justify-center mt-2">
            <motion.a
              target={"_blank"}
              className="w-6 m-1 mx-3 dark:bg-dark sm:mx-1"
              href="https://github.com/labinotveseli"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              aria-label="Checkout my github profile"
